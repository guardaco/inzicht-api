...
var home = process.env.INSIGHT_DB || (getUserHome() + '/.guldencoin-insight');
...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\Guldencoin\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/Guldencoin/';
  if (isLinux) dataDir = process.env.HOME + '/.guldencoin/';
}
...
var bitcoindConf = {
  ...
  user: process.env.BITCOIND_USER || 'guldenuser',
  pass: process.env.BITCOIND_PASS || 'guldenpass',
