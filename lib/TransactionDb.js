...
var encodedData = require('soop').load('Nlgcore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('Nlgcore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('Nlgcore/lib/Address', {
